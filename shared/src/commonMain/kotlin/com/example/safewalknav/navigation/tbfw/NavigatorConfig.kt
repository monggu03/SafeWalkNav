...
data class NavigatorConfig(
    ...
    val curveCumulativeThresholdDeg: Double = 45.0,
    ...
    val minDistanceFromExistingWaypointM: Double = 12.0,
    val minDistanceBetweenVirtualWaypointsM: Double = 15.0,
    val curveAnnouncementDistanceM: Double = 20.0,
    val minSpeechIntervalForCurveMs: Long = 5_000L,
